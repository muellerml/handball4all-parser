...
class LeagueParser {
    ...
    internal suspend fun currentGames(leagueId: Int): CurrentGameHolder
        = detectBreakingApiChanges {
...
internal data class H4aPartlyParsedLeague(private val content: H4APartlyLeagueContent, val head: H4aLeagueHeader) {
    fun currentGames() = CurrentGameHolder(currentGames = content.currentGames(),
...
internal data class H4APartlyLeagueContent(private val futureGames: H4AGameHolder,
    ...
    fun currentGames(): List<ParsedGame> = actualGames.parsedGames
...
internal data class H4AGame(val gNo: String,
